...
Пошаговый запуск, витрины сценариев и разбор типичных ошибок:
[DEMO_MODE.md](DEMO_MODE.md). Полная замена рабочей БД:
[SINGLE_IMAGE_DEMO_RUNBOOK.md](SINGLE_IMAGE_DEMO_RUNBOOK.md).
