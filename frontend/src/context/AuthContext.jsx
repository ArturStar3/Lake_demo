...
const demoAutoLoginEnabled = import.meta.env.VITE_DEMO_AUTO_LOGIN === 'true';
...
export function AuthProvider({ children }) {
  ...
  const [loading, setLoading] = useState(() => Boolean(getAccessToken()) || demoAutoLoginEnabled);
  ...
  useEffect(() => {
    ...
    if (demoAutoLoginEnabled) {
      performDemoLogin().catch(() => {
        setUser(null);
        setLoading(false);
      });
    } else {
